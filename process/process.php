...
ALLOWED_EXTENSIONS = array('jpg', 'jpeg', 'pdf', 'doc', 'png'), // разрешённые расширения файлов
MAIL_FROM = 't3st0q@yandex.ru', // от какого email будет отправляться письмо
...
MAIL_ADDRESS = 'const.trofimov@gmail.com', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 't3st0q@yandex.ru', // SMTP-пользователь
MAIL_SMTP_PASSWORD = 'uhavqxxwubgthhrt'; // SMTP-пароль
